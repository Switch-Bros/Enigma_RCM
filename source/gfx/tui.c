...
void tui_sbar(bool force_update)
{
	...
	gfx_printf("%K%k Akku: %d.%d%% (%d mV) - Ladezustand:", 0xFF303030, 0xFF888888,
	...
	if (battVoltCurr >= 0)
		gfx_printf(" %k+%d mA%k%K\n",
			0xFF00DD00, battVoltCurr / 1000, 0xFFCCCCCC, 0xFF1B1B1B);
	else
		gfx_printf(" %k-%d mA%k%K\n",
			0xFFDD0000, (~battVoltCurr) / 1000, 0xFFCCCCCC, 0xFF1B1B1B);
